...
stripe.api_key = "sk_test_5108pTdAElJdARQCXIcA4uho5dmrRRl4o4rV0h6Yc157Yo1ssQIgBkEfZSlNqzMR94k00F1A4thY4kKgUn7zyUKRY003MI3DXYz"
...
def register():
	...
	if form.validate_on_submit():
		...
		new_user = User(name=form.name.data,
						email=form.email.data,
						password=form.password.data,                   #check app_sec version
